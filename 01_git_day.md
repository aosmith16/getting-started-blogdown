...
either :stuck\_out\_tongue\_winking\_eye: but these are the top two
recommendations in Happy Git).
...
Go to the repository page on GitHub and then go to `Settings`. Scroll
