...
knitr::include_graphics("./01_git_day_files/pics/git_start_window.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("./01_git_day_files/pics/git_command_prompt.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("./01_git_day_files/pics/git_openbash.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("./01_git_day_files/pics/github_newrepo.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("./01_git_day_files/pics/github_clone.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("./01_git_day_files/pics/rstudio_vcontrol.png")
```

And then `Git`

```{r, echo = FALSE}
knitr::include_graphics("./01_git_day_files/pics/rstudio_git.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("./01_git_day_files/pics/rstudio_clone.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("./01_git_day_files/pics/rstudio_gittab.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("./01_git_day_files/pics/rstudio_findgit.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("./01_git_day_files/pics/rstudio_push.png")
```
