...
```{r, echo = FALSE}
knitr::include_graphics("pics/git_start_window.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("pics/git_command_prompt.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("pics/git_openbash.png")
```

## Mac OS

I'm putting two options here (I don't have a Mac so have never tried either but these `r emo::ji("stuck_out_tongue_winking_eye") are the top two recommendations in happygitwithr.com).
...
```{r, echo = FALSE}
knitr::include_graphics("pics/github_newrepo.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("pics/github_clone.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("pics/rstudio_vcontrol.png")
```

And then `Git`

```{r, echo = FALSE}
knitr::include_graphics("pics/rstudio_git.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("pics/rstudio_clone.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("pics/rstudio_gittab.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("pics/rstudio_findgit.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("pics/rstudio_push.png")
```
